...
public class AdminUpdateUserStatusController implements Initializable {
    ...
    private void loadSampleData() {
        allUsers = FXCollections.observableArrayList(
                new User(1, "Naimur Rahman", "Client", "Active", LocalDate.of(2024, 1, 15), "naimur@email.com"),
                new User(2, "Samira Fatema", "Freelancer", "Active", LocalDate.of(2024, 2, 20), "samira@email.com"),
                new User(3, "Shahnewaz Shawon", "Admin", "Active", LocalDate.of(2023, 12, 10), "shawon@email.com"),
                new User(4, "Abir Hossain", "Project Manager", "Inactive", LocalDate.of(2024, 3, 5), "abir@email.com"),
                new User(5, "ABCD", "HR Manager", "Active", LocalDate.of(2024, 1, 25), "abcd@email.com")
        );
    }

    @FXML
    void handleBack(ActionEvent event) {
        switchScene(event, "/cse213/group19fc/AdminDashboard.fxml");
    }
