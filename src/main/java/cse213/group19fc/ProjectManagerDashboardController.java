...
public class ProjectManagerDashboardController {
    ...
    void handleArchiveProjects(ActionEvent event) {
        switchScene(event, "/cse213/group19fc/Samira/PMArchiveProjects.fxml");
    }

    @FXML
    void handleAssignFreelancers(ActionEvent event) {
        switchScene(event, "/cse213/group19fc/Samira/PMAssignFreelancers.fxml");
    }

    @FXML
    void handleCreateChecklist(ActionEvent event) {
        switchScene(event, "/cse213/group19fc/Samira/PMCreateChecklist.fxml");
    }

    @FXML
    void handleCreateSchedule(ActionEvent event) {
        switchScene(event, "/cse213/group19fc/Samira/PMCreateSchedule.fxml");
    }

    @FXML
    void handleEditProject(ActionEvent event) {
        switchScene(event, "/cse213/group19fc/Samira/PMEditProjectUpdates.fxml");
    }

    @FXML
    void handleEditProjectDetails(ActionEvent event) {
        switchScene(event, "/cse213/group19fc/Samira/PMEditProjectDetails.fxml");
    }
    ...
    void handleManageDeadlines(ActionEvent event) {
        switchScene(event, "/cse213/group19fc/Samira/PMManageDeadlines.fxml");
    }

    @FXML
    void handleMonitorBudget(ActionEvent event) {
        switchScene(event, "/cse213/group19fc/Samira/PMMonitorBudget.fxml");
    }
